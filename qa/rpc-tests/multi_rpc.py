...
class HTTPBasicsTest (BitcoinTestFramework):
    ...
    def setup_chain(self):
        super().setup_chain()
        #Append rpcauth to shroud.conf before initialization
        ...
        print(os.path.join(self.options.tmpdir+"/node0", "shroud.conf"))
        with open(os.path.join(self.options.tmpdir+"/node0", "shroud.conf"), 'a', encoding='utf8') as f:
            f.write(rpcauth+"\n")
            f.write(rpcauth2+"\n")
