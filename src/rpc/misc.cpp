...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nReturn information about the given Shroud address.\n"
            "\nArguments:\n"
            "1. \"shroudaddress\"     (string, required) The Shroud address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"shroudaddress\", (string) The Shroud address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: Shroud address and we have full public key:
