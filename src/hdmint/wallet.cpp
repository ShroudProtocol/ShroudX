 ...
 *
 * See https://github.com/ShroudXProject/Shroud/pull/392 for specification on mint generation.
 * 
...
{
    if(!shroudnodeSync.IsBlockchainSynced() && !fAllowUnsynced && !(Params().NetworkIDString() == CBaseChainParams::REGTEST))
