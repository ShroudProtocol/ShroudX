...
extern const char *SHROUDNODEPAYMENTVOTE;
extern const char *SHROUDNODEPAYMENTSYNC;
...
enum GetDataMsg
{
    ...
    MSG_SPORK,
    MSG_SHROUDNODE_PAYMENT_VOTE,
    MSG_SHROUDNODE_PAYMENT_BLOCK,
    MSG_SHROUDNODE_ANNOUNCE,
    MSG_SHROUDNODE_PING,
    MSG_SHROUDNODE_VERIFY,
    MSG_TXLOCK_REQUEST,
    MSG_TXLOCK_VOTE,
    MSG_DSTX,
    DSQUEUE,
