...
//static const int64_t DUST_SOFT_LIMIT = 100000; // 0.001 SHROUD
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64_t DUST_HARD_LIMIT = 1000;   // 0.00001 SHROUD mininput

// There were bugs before this block, don't do some checks on early blocks
#define ZC_CHECK_BUG_FIXED_AT_BLOCK         1

// Before this block we allowed not paying to the shroudnodes.
#define ZC_SHROUDNODE_PAYMENT_BUG_FIXED_AT_BLOCK         1
